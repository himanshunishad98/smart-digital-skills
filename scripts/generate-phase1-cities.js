...
const cities = [
  ...
  { 
    id: 'ranchi', 
    name: 'Ranchi', 
    tagline: 'Empowering Ranchi\'s students with future-ready computer skills',
    areas: 'Lalpur, Doranda, and Ashok Nagar',
    focus: 'ensuring affordable and high-quality online digital skill development for Ranchi\'s youth.',
    faqQuestion: 'Where can students in Ranchi learn MS Office and AI practically?',
    faqAnswer: 'Our specialized online batch for Class 6-8 allows students in Ranchi to master MS Excel, PowerPoint, Word, and basic AI through live, interactive projects.'
  },
  { 
    id: 'bhopal', 
    name: 'Bhopal', 
...
if (entriesAdded > 0) {
  ...
  console.log('\nAll Phase 1 URLs already present in sitemap-cities.xml.');
}
